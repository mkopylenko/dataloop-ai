...
var rabbit_mq_1 = require("./3rd-parties/rabbit-mq");
var publisher_service_1 = require("./services/publisher.service");
var cities_1 = require("./cities/cities");
var streets_service_1 = require("./services/streets.service");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    console.log(cityVal);
                    return [4 /*yield*/, publisher_service_1.PublishingService.publish(cityVal, new rabbit_mq_1.default(), new streets_service_1.StreetsService())];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
